...
<body>
    <div id="app">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto">
                        ...
                        @if (Auth::user())
                            ...
                            <a class="nav-link" href="{{ route('admin.dashboarde') }}">
                                Dashboard
                            </a>
                            @endif
                        @endif
     ...
     {{-- <script src="{{ asset('js/custom/scripte.js') }}" defer></script> --}}
    ...
    <script src="{{ asset('js/dashboard.js') }}" ></script>
     <script type="text/javascript">
         var url= "{{route('certificates.like')}}";
         var url_dis= "{{route('certificates.dislike')}}";
